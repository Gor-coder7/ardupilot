...
# include USERHOOK_VARIABLES
    ...
    void Log_Write_Hit_Target_Position_Target(ModeHitTarget::SubMode submode, const Vector3f& pos_target, bool terrain_alt, const Vector3f& vel_target, const Vector3f& accel_target);
    void Log_Write_Hit_Target_Attitude_Target(ModeHitTarget::SubMode target_type, float roll, float pitch, float yaw, const Vector3f &ang_vel, float thrust, float climb_rate);
